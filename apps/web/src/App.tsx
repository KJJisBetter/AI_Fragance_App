...
const FragrancesPage = lazy(() =>
  import('./pages/FragrancesPage').then(module => ({ default: module.FragrancesPage }))
)
const FragranceDetailPage = lazy(() =>
  import('./pages/FragranceDetailPage').then(module => ({ default: module.FragranceDetailPage }))
)
const BattlesPage = lazy(() =>
  import('./pages/BattlesPage').then(module => ({ default: module.BattlesPage }))
)
const BattleDetailPage = lazy(() =>
  import('./pages/BattleDetailPage').then(module => ({ default: module.BattleDetailPage }))
)
const AICategorizePage = lazy(() =>
  import('./pages/AICategorizePage').then(module => ({ default: module.AICategorizePage }))
)
