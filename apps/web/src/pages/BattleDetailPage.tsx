import { BattleStatus, type BattleWithItems } from '@fragrance-battle/types'
...
export const BattleDetailPage = () => {
  ...
  const handleCompleteBattle = async () => {
    ...
    const confirmed = window.confirm(
      'Are you sure you want to complete this battle? This action cannot be undone.'
    )
    if (!confirmed) return
  ...
  return (
    ...
    >
      ...
      >
        ...
        <span>→</span>
        <span style={{ color: '#1e293b', fontWeight: '500' }}>{battle.title}</span>
      </nav>
