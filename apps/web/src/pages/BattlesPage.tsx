import { BattleStatus, type BattleWithItems, type Fragrance } from '@fragrance-battle/types'
    ...
    >
      ...
      {battles.length === 0 ? (
        ...
        >
          ...
          >
            Create fragrance battles to compare your favorites and
            <br />
                    ...
                    >
                      ...
                      >
                        ...
                        <div>
                          ...
                          >
                            {winner.fragrance.brand} • {winner.votes} votes (
                ...
                >
                  {selectedFragrances.map(fragrance => (
                    ...
                    >
                      ...
                      <button
                        onClick={() => {
                          setSelectedFragrances(prev => prev.filter(f => f.id !== fragrance.id))
                        }}
                        style={{
                  ...
                  {searching ? (
                    ...
                    searchResults.map(fragrance => (
                      <div
                        ...
                        onClick={() => {
                          const alreadySelected = selectedFragrances.find(
                            f => f.id === fragrance.id
                          )
                      ...
                      >
                        ...
                        >
                          ...
                          {selectedFragrances.find(f => f.id === fragrance.id) && (
                            <span style={{ color: '#22c55e', marginLeft: '8px' }}>✓ Selected</span>
                          )}
                        </div>
                      </div>
                    ))
            ...
            >
              ...
              <button
                ...
                style={{
                  padding: '12px 24px',
                  backgroundColor:
                    creating || !newBattleTitle.trim() || selectedFragrances.length < 2
                      ? '#94a3b8'
                      : '#1e293b',
                  color: 'white',
                  border: 'none',
