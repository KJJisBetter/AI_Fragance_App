...
import { CollectionWithItems, CollectionItem, Fragrance } from "@fragrance-battle/types";
...
export const CollectionDetailPage = () => {
  ...
  const handleRemoveItem = async (itemId: string) => {
    ...
    const confirmed = window.confirm("Are you sure you want to remove this fragrance from your collection?");
    if (!confirmed) return;
  ...
  const getAnalytics = () => {
    ...
    const averageRating = ratedItems > 0
    ...
    // Year distribution
    const yearCounts = items.reduce((acc, item) => {
