import type { CollectionWithItems } from '@fragrance-battle/types'
  ...
  useEffect(() => {
    const fetchCollections = async () => {
      try {
        ...
        setError(
          `Failed to load collections: ${err instanceof Error ? err.message : 'Unknown error'}`
        )
      } finally {
        setLoading(false)
      }
    ...
    >
      ...
      {collections.length === 0 ? (
        ...
        >
          ...
          >
            Collections help you organize and keep track of your favorite fragrances.
            <br />
