...
import { fragrancesApi, collectionsApi } from "../lib/api";
import { Fragrance, Collection } from "@fragrance-battle/types";
...
export const FragranceDetailPage = () => {
    ...
    const fetchFragrance = async () => {
      ...
      try {
        ...
        if (err instanceof Error && err.message.includes('404')) {
          ...
          setError(`Failed to load fragrance: ${err instanceof Error ? err.message : 'Unknown error'}`);
        }
      } finally {
        setLoading(false);
      }
  ...
  return (
    <div style={{
      ...
      <div id="battle-performance-placeholder" style={{
        backgroundColor: "#f8fafc",
        borderRadius: "12px",
        padding: "48px 32px",
        textAlign: "center",
        ...
        <p style={{
          ...
          Battle performance metrics and head-to-head comparisons will be displayed here once the battle system is implemented.
        </p>
      </div>
